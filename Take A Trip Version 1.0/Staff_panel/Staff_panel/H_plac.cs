...
{
    public partial class H_plac : Form
    {
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                string query = "insert into Historical_places values(@P_name, @Data, @pic)";
        ...
        {
            SqlConnection con = new SqlConnection(cs);
            string query = "SELECT * FROM Historical_places";
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            SqlConnection con = new SqlConnection(cs);
            string query = "update Historical_places set P_Name = @P_name, P_des = @Data, P_Picture = @pic where P_Name = @P_name";
            SqlCommand cmd = new SqlCommand(query, con);
            cmd.Parameters.AddWithValue("@P_name", textBox1.Text);
            cmd.Parameters.AddWithValue("@Data", richTextBox1.Text);
            cmd.Parameters.AddWithValue("@pic", saveImage());
        ...
        private void button6_Click(object sender, EventArgs e)
        {
            // Delete button...........................................
            SqlConnection con = new SqlConnection(cs);
            string query = "delete from Historical_places where P_Name = @P_name";
            SqlCommand cmd = new SqlCommand(query, con);
            cmd.Parameters.AddWithValue("@P_name", textBox1.Text);
