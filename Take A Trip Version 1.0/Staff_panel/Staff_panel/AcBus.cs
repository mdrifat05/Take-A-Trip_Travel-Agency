...
namespace Staff_panel
{
    public partial class AcBus : Form
    {
        ...
        private void button1_Click_1(object sender, EventArgs e)
        {
            ...
            {
                SqlConnection con = new SqlConnection(cs);
                string query = "insert into AC_Bus values(@T_Name, @T_Number, @T_price)";
        ...
        private void button2_Click_1(object sender, EventArgs e)
        {
            //. Update..............................
            SqlConnection con = new SqlConnection(cs);
            string query = "update AC_Bus set T_Name = @T_name, T_Number = @T_Number, T_Price = @T_price where T_Name = @T_name";
            SqlCommand cmd = new SqlCommand(query, con);
            cmd.Parameters.AddWithValue("@T_name", textBox1.Text);
            cmd.Parameters.AddWithValue("@T_Number", textBox3.Text);
            cmd.Parameters.AddWithValue("@T_price", textBox2.Text);
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            //delete ..................................
            SqlConnection con = new SqlConnection(cs);
            string query = "delete from AC_Bus where T_Name = @T_name";
            SqlCommand cmd = new SqlCommand(query, con);
            cmd.Parameters.AddWithValue("@T_name", textBox1.Text);
