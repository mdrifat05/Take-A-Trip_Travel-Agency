    ...
    public partial class Sea : Form
    {
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                string query = "insert into Sea values(@P_name, @P_des, @P_Picture)";
                SqlCommand cmd = new SqlCommand(query, con);
                cmd.Parameters.AddWithValue("@P_name", textBox1.Text);
                cmd.Parameters.AddWithValue("@P_des", richTextBox1.Text);
                cmd.Parameters.AddWithValue("@P_Picture", saveImage());
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            SqlConnection con = new SqlConnection(cs);
            string query = "update Sea set P_Name = @P_name, P_des = @Data, P_Picture = @pic where P_Name = @P_name";
            SqlCommand cmd = new SqlCommand(query, con);
            cmd.Parameters.AddWithValue("@P_name", textBox1.Text);
        ...
        private void button6_Click(object sender, EventArgs e)
        {
            // Delete button...........................................
            SqlConnection con = new SqlConnection(cs);
            string query = "delete from Sea where P_Name = @P_name";
            SqlCommand cmd = new SqlCommand(query, con);
            cmd.Parameters.AddWithValue("@P_name", textBox1.Text);
