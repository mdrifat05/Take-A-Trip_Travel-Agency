...
namespace Staff_panel
{
    public partial class FourStar_DuelBed : Form
    {
        ...
        void BindGridView()
        {
            ...
            string query = "SELECT * FROM FourStar_DuelBed";
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            {
                SqlConnection con = new SqlConnection(cs);
                string query = "insert into FourStar_DuelBed values(@Hotel_Name, @Hotel_Number, @Hotel_Price, @Hotel_Picture)";
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            //. Update..............................
            SqlConnection con = new SqlConnection(cs);
            string query = "update  FourStar_DuelBed set Hotel_Name = @H_name, Hotel_Number = @H_num, Hotel_Price = @H_Price, Hotel_Picture = @H_pic where Hotel_Name = @H_name";
            SqlCommand cmd = new SqlCommand(query, con);
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            // Delete button...........................................
            SqlConnection con = new SqlConnection(cs);
            string query = "delete from FourStar_DuelBed where Hotel_Name = @H_name";
            SqlCommand cmd = new SqlCommand(query, con);
            cmd.Parameters.AddWithValue("@H_name", textBox1.Text); 
